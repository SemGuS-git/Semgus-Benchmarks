...
;;(constraint (Start.Sem bvformula #xf0000000 #x10000000 ))
;;(constraint (Start.Sem bvformula #xffffffff #x00000001 ))
;;(constraint (Start.Sem bvformula #x0000000e #x00000002 ))
(constraint (forall ((x (_ BitVec 32)) (result (_ BitVec 32)))
            (= (Start.Sem bvformula x result)
                (= result (bvand x (bvneg x)) ))))
