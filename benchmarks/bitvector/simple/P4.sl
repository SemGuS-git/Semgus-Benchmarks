;; form a mask that identifies the rightmost 1 bit and trailing 0's
...
;;(constraint (Start.Sem bvformula #x00000000 #xffffffff ))
;;(constraint (Start.Sem bvformula #x00010000 #x0001ffff ))
;;(constraint (Start.Sem bvformula #x00ef4000 #x00007fff ))
(constraint (forall ((x (_ BitVec 32)) (result (_ BitVec 32)))
            (= (Start.Sem bvformula x result)
                (= result (bvxor x (bvsub x #x00000001)) ))))
