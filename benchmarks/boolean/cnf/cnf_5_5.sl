;; cnf_5_5: synthesize a cnf from 5 variables
...
(constraint (B.Sem formula true false false false true  false))
(constraint (B.Sem formula true false true false false  false))
(constraint (B.Sem formula true false true false true  false))
