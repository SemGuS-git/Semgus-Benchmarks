;; cnf_5_6: synthesize a cnf from 5 variables
...
(constraint (B.Sem formula true false false true false  false))
(constraint (B.Sem formula true false false true true  false))
(constraint (B.Sem formula true false true true false  false))
(constraint (B.Sem formula true false true true true  false))
(constraint (B.Sem formula true true false true false  false))
(constraint (B.Sem formula true true false true true  false))
(constraint (B.Sem formula true true true true false  false))
(constraint (B.Sem formula true true true true true  false))
