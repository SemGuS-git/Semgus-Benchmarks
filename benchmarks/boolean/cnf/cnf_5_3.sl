;; cnf_5_3: synthesize a cnf from 5 variables
...
(constraint (B.Sem formula false false true true false  true))
(constraint (B.Sem formula false false true true true  true))
