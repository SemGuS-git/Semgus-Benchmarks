;; cnf_5_7: synthesize a cnf from 5 variables
...
;; solution: (v1 v v2 v ~v3 v ~v4) ^ (~v2 v v4 v v5)
...
(constraint (B.Sem formula false false true false false  true))
(constraint (B.Sem formula false false true false true  true))
...
(constraint (B.Sem formula false true true true false  true))
