;; dnf_5_2: synthesize a dnf from 5 variables
...
(constraint (B.Sem formula false false false false false  true))
(constraint (B.Sem formula false false false false true  true))
(constraint (B.Sem formula false false false true false  true))
(constraint (B.Sem formula false false false true true  true))
(constraint (B.Sem formula false true false false false  true))
(constraint (B.Sem formula false true false false true  true))
(constraint (B.Sem formula false true false true false  true))
(constraint (B.Sem formula false true false true true  true))
(constraint (B.Sem formula true false false false false  true))
...
(constraint (B.Sem formula true false true false false  true))
...
(constraint (B.Sem formula true true false false false  true))
...
(constraint (B.Sem formula true true true false false  true))
(constraint (B.Sem formula true true true false true  true))
(constraint (B.Sem formula true true true true false  true))
...
(constraint (B.Sem formula false true true false true  false))
(constraint (B.Sem formula false true true true false  false))
(constraint (B.Sem formula false true true true true  false))
