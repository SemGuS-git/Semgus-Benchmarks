...
(constraint (Start.Sem match_regex "00011000" true))
(constraint (Start.Sem match_regex "00100110001" true))
...
(constraint (Start.Sem match_regex "00011001100" false))
(constraint (Start.Sem match_regex "011100011110" false))
(check-synth)
