...
(constraint (Start.Sem match_regex "00010100" true))
(constraint (Start.Sem match_regex "00010101" true))
(constraint (Start.Sem match_regex "00010110" true))
(constraint (Start.Sem match_regex "00010111" true))
(constraint (Start.Sem match_regex "01010100" true))
(constraint (Start.Sem match_regex "01010101" true))
(constraint (Start.Sem match_regex "01010110" true))
(constraint (Start.Sem match_regex "01010111" true))
(constraint (Start.Sem match_regex "10010100" true))
(constraint (Start.Sem match_regex "10010101" true))
(constraint (Start.Sem match_regex "10010110" true))
(constraint (Start.Sem match_regex "10010111" true))
(constraint (Start.Sem match_regex "11010100" true))
(constraint (Start.Sem match_regex "11010101" true))
(constraint (Start.Sem match_regex "11010110" true))
(constraint (Start.Sem match_regex "11010111" true))
