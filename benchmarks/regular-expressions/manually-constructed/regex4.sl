...
(define-funs-rec
    ...
    (
        (! (match t (
            (($eval t1) (exists
                ( (X_0_0 Bool) (X_0_1 Bool) (X_0_2 Bool) (X_0_3 Bool) (X_0_4 Bool) (X_1_2 Bool) (X_1_3 Bool) (X_1_4 Bool) (X_2_3 Bool) (X_2_4 Bool) (X_3_4 Bool))
                (and
        ...
        (! (match t (
            ...
            ($phi (and  (= X_0_0 false) (= X_0_1 false) (= X_0_2 false) (= X_0_3 false) (= X_0_4 false) (= X_1_2 false) (= X_1_3 false) (= X_1_4 false)
                 (= X_2_3 false) (= X_2_4 false) (= X_3_4 false)))
            ($any (and  (= X_0_0 false) (= X_0_1 true) (= X_0_2 false) (= X_0_3 false) (= X_0_4 false) (= X_1_2 true) (= X_1_3 false) (= X_1_4 false)
                 (= X_2_3 true) (= X_2_4 false) (= X_3_4 true)))
            ($char_1 (and  (= X_0_0 false) (= X_0_1 (= s_0 1)) (= X_0_2 false) (= X_0_3 false) (= X_0_4 false) (= X_1_2 (= s_1 1)) (= X_1_3 false) (= X_1_4 false)
                 (= X_2_3 (= s_2 1)) (= X_2_4 false) (= X_3_4 (= s_3 1))))
            ($char_2 (and  (= X_0_0 false) (= X_0_1 (= s_0 2)) (= X_0_2 false) (= X_0_3 false) (= X_0_4 false) (= X_1_2 (= s_1 2)) (= X_1_3 false) (= X_1_4 false)
                 (= X_2_3 (= s_2 2)) (= X_2_4 false) (= X_3_4 (= s_3 2))))
            (($or t1 t2)
                (exists
                    (
...
(constraint (Start.Sem match_regex 2 1 1 3 false))
(constraint (Start.Sem match_regex 3 1 2 1 false))
