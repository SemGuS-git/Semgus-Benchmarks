...
(define-funs-rec
    (
        ...
        (R.Sem ((t R) (s_0 Int) (s_1 Int) (s_2 Int) (X_0_0 Bool) (X_0_1 Bool) (X_0_2 Bool) (X_0_3 Bool) (X_1_2 Bool) (X_1_3 Bool) (X_2_3 Bool)) Bool)
    )
    
    (
        (! (match t (
            (($eval t1) (exists
                ((X_0_0 Bool) (X_0_1 Bool) (X_0_2 Bool) (X_0_3 Bool) (X_1_2 Bool) (X_1_3 Bool) (X_2_3 Bool))
                (and
                    (R.Sem t1 s_0 s_1 s_2 X_0_0 X_0_1 X_0_2 X_0_3 X_1_2 X_1_3 X_2_3)
                    (= result X_0_3)
                )
            ))
        )) :input (s_0 s_1 s_2) :output (result))
        (! (match t (
            ($eps (and (= X_0_0 true) (= X_0_1 false) (= X_0_2 false) (= X_0_3 false) (= X_1_2 false) (= X_1_3 false) (= X_2_3 false)))
            ($phi (and (= X_0_0 false) (= X_0_1 false) (= X_0_2 false) (= X_0_3 false) (= X_1_2 false) (= X_1_3 false) (= X_2_3 false)))
            ($char_1 (and (= X_0_0 false) (= X_0_1 (= s_0 1)) (= X_0_2 false) (= X_0_3 false) (= X_1_2 (= s_1 1)) (= X_1_3 false) (= X_2_3 (= s_2 1))))
            ($char_2 (and (= X_0_0 false) (= X_0_1 (= s_0 2)) (= X_0_2 false) (= X_0_3 false) (= X_1_2 (= s_1 2)) (= X_1_3 false) (= X_2_3 (= s_2 2))))
            ($any (and (= X_0_0 false) (= X_0_1 (> s_0 0)) (= X_0_2 false) (= X_0_3 false) (= X_1_2 (> s_1 0)) (= X_1_3 false) (= X_2_3 (> s_2 0))))
            (($neg t1)
                (exists
                    (
                        (A_0_0 Bool) (A_0_1 Bool) (A_0_2 Bool) (A_0_3 Bool) (A_1_2 Bool) (A_1_3 Bool) (A_2_3 Bool)
                    )
                    (and 
                        (R.Sem t1 s_0 s_1 s_2 A_0_0 A_0_1 A_0_2 A_0_3 A_1_2 A_1_3 A_2_3)
                        (and 
                            (= X_0_0 (not A_0_0)) 
                            (= X_0_1 (not A_0_1)) 
                            (= X_0_2 (not A_0_2)) 
            ...
            (($or t1 t2)
                (exists
                    (
                        (A_0_0 Bool) (A_0_1 Bool) (A_0_2 Bool) (A_0_3 Bool) (A_1_2 Bool) (A_1_3 Bool) (A_2_3 Bool)
                        (B_0_0 Bool) (B_0_1 Bool) (B_0_2 Bool) (B_0_3 Bool) (B_1_2 Bool) (B_1_3 Bool) (B_2_3 Bool)
                    )
                    (and 
                        (R.Sem t1 s_0 s_1 s_2 A_0_0 A_0_1 A_0_2 A_0_3 A_1_2 A_1_3 A_2_3)
                        (R.Sem t2 s_0 s_1 s_2 B_0_0 B_0_1 B_0_2 B_0_3 B_1_2 B_1_3 B_2_3)
                        (and 
            ...
            ; \ 23 ,
            ; \
        )) :input (s_0 s_1 s_2) :output (X_0_0 X_0_1 X_0_2 X_0_3 X_1_2 X_1_3 X_2_3))
    )
)
