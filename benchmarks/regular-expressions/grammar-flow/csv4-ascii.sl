...
;; [num, (alpha)*]
(constraint (Start.Sem match_regex 49 44 97 98 true))   ;; 1,ab --> true
(constraint (Start.Sem match_regex 52 44 98 99 true))   ;; 4,bc --> true
(constraint (Start.Sem match_regex 97 44 98 99 false))  ;; a,bc --> false
(constraint (Start.Sem match_regex 49 50 44 97 false))  ;; 12,a --> false
