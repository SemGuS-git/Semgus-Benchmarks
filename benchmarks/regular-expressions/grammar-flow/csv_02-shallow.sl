...
;; [num, alpha, (num)*]
(constraint (Start.Sem match_regex "6,n,720" true))
(constraint (Start.Sem match_regex "7,l,512" true))
(constraint (Start.Sem match_regex "1234" false))
(constraint (Start.Sem match_regex "str,str,str" false))
(constraint (Start.Sem match_regex "72,l,608" false))
(constraint (Start.Sem match_regex "7,li,608" false))
(constraint (Start.Sem match_regex "608,name" false))
(constraint (Start.Sem match_regex "name,name,512" false))
