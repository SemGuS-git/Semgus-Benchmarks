...
(constraint (Start.Sem match_regex "00100100" true))
(constraint (Start.Sem match_regex "1111" true))
(constraint (Start.Sem match_regex "010101010" true))
(constraint (Start.Sem match_regex "00100100100100" true))
...
(constraint (Start.Sem match_regex "0101010" false))
