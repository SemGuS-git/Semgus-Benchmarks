...
(define-funs-rec
    ...
    (
        ...
        (! (match t (
            ...
            ($char_0 (and  (= X_0_0 false) (= X_0_1 (= s_0 0)) (= X_0_2 false) (= X_0_3 false) (= X_0_4 false) (= X_1_1 false) (= X_1_2 (= s_1 0)) (= X_1_3 false) (= X_1_4 false) (= X_2_2 false) (= X_2_3 (= s_2 0)) (= X_2_4 false) (= X_3_3 false) (= X_3_4 (= s_3 0)) (= X_4_4 false)))
...
(constraint (Start.Sem match_regex 2 20 20 40 40 true))
(constraint (Start.Sem match_regex 3 20 20 20 40 true))
(constraint (Start.Sem match_regex 4 20 20 20 20 true))
(constraint (Start.Sem match_regex 1 0 40 40 40 false))
(constraint (Start.Sem match_regex 1 1 40 40 40 false))
(check-synth)
