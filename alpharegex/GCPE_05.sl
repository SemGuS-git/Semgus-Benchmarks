...
(constraint (Start.Sem match_regex 4 20 20 0 20 40 true))
(constraint (Start.Sem match_regex 5 20 20 0 20 20 true))
(constraint (Start.Sem match_regex 1 30 40 40 40 40 false))
(constraint (Start.Sem match_regex 2 30 30 40 40 40 false))
(constraint (Start.Sem match_regex 3 30 30 1 40 40 false))
(constraint (Start.Sem match_regex 4 30 30 1 30 40 false))
(check-synth)
